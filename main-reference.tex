...
%% @FilePath         : /BachelorThesis/main.tex
%% @LastTime         : 2024-03-29 09:29:05
...
% !TEX root = /workspaces/BachelorThesis/main.tex.
...
%\maketitle
% 插入封面，针对苏大本科生毕业论文
%\includepdf[pages={1}]{./figures/cover-zh.pdf}
% 生成封面，针对苏大研究生毕业论文中文版
%\titlech
% 生成封面，针对苏大研究生毕业论文英文版
%\titleeng
...
\input{contents/reference-others}
%\input{contents/back.tex}
...
\backmatter
% 参考文献
\bibliography{reference/AccountThesis}  % 参考文献使用 BibTeX 编译(本科生)
